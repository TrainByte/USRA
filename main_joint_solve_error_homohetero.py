...
def main(args):
    ...
    H_all_with_error = data['arr_6']  # 带有信道估计误差的信道增益
    '''
    ...
    H_all_2_with_error = []
    # 读取带有信道估计误差的信道增益并进行平方及归一化
    for t in range(total_samples):
        H_all_2_with_error.append(H_all_with_error[t] ** 2 / noise_var)  # H_all为开根号的数据，需要进行平方
    ...
    for t in range(total_samples):  # 对于整个total_samples时间轴上的数据分帧进行处理
        ...
        while num_iter < max_iter:
            ...
            if num_iter == 0:
                ...
                channel allocation
                '''
                problem = MyProblem_Drop(H_all_2_with_error[t], p_previous, u, n, m, cpu_cycles, cell_mapping[:, t],
                ...
                '''
                latency_current,_ = pb.user_uplink_time(H_all_2_with_error[t], channel_current, p_previous, task_matrix[:, t], u, W,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--json-file', type=str,
                        default='M3_U30_N5_Task_u15000_Ucpu_e1000_Tdemand_u15_error001_homo_fix',
